...
If you are creating a new simplebuild project, you can get easily
started by simply invoking ``sb --init [optional flags]`` in the directory under
which you wish to keep your package bundle. As explained in `the dedicated
documentation for sb -\-init
<./cmdline.html#new-project-initialisation-options>`_ this will generate a
